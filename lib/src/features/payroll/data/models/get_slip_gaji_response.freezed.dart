...
@override
String toString() {
  return 'GetSlipGajiResponse(penggajianId: $penggajianId, periodeBulan: $periodeBulan, periodeTahun: $periodeTahun, periodeLabel: $periodeLabel, gajiBersih: $gajiBersih, sudahDitransfer: $sudahDitransfer)';
}
...
/// @nodoc
abstract mixin class $GetSlipGajiResponseCopyWith<$Res>  {
  factory $GetSlipGajiResponseCopyWith(GetSlipGajiResponse value, $Res Function(GetSlipGajiResponse) _then) = _$GetSlipGajiResponseCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GetSlipGajiResponseCopyWithImpl<$Res>
    implements $GetSlipGajiResponseCopyWith<$Res> {
  _$GetSlipGajiResponseCopyWithImpl(this._self, this._then);

  final GetSlipGajiResponse _self;
  final $Res Function(GetSlipGajiResponse) _then;
...
/// Adds pattern-matching-related methods to [GetSlipGajiResponse].
extension GetSlipGajiResponsePatterns on GetSlipGajiResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GetSlipGajiResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetSlipGajiResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GetSlipGajiResponse value)  $default,){
final _that = this;
switch (_that) {
case _GetSlipGajiResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GetSlipGajiResponse value)?  $default,){
final _that = this;
switch (_that) {
case _GetSlipGajiResponse() when $default != null:
return $default(_that);case _:
...
class _GetSlipGajiResponse implements GetSlipGajiResponse {
  const _GetSlipGajiResponse({required this.penggajianId, required this.periodeBulan, required this.periodeTahun, required this.periodeLabel, required this.gajiBersih, required this.sudahDitransfer});
  factory _GetSlipGajiResponse.fromJson(Map<String, dynamic> json) => _$GetSlipGajiResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$GetSlipGajiResponseCopyWith<_GetSlipGajiResponse> get copyWith => __$GetSlipGajiResponseCopyWithImpl<_GetSlipGajiResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GetSlipGajiResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetSlipGajiResponse&&(identical(other.penggajianId, penggajianId) || other.penggajianId == penggajianId)&&(identical(other.periodeBulan, periodeBulan) || other.periodeBulan == periodeBulan)&&(identical(other.periodeTahun, periodeTahun) || other.periodeTahun == periodeTahun)&&(identical(other.periodeLabel, periodeLabel) || other.periodeLabel == periodeLabel)&&(identical(other.gajiBersih, gajiBersih) || other.gajiBersih == gajiBersih)&&(identical(other.sudahDitransfer, sudahDitransfer) || other.sudahDitransfer == sudahDitransfer));
}
...
/// @nodoc
abstract mixin class _$GetSlipGajiResponseCopyWith<$Res> implements $GetSlipGajiResponseCopyWith<$Res> {
  factory _$GetSlipGajiResponseCopyWith(_GetSlipGajiResponse value, $Res Function(_GetSlipGajiResponse) _then) = __$GetSlipGajiResponseCopyWithImpl;
@override @useResult
$Res call({
 String penggajianId, int periodeBulan, int periodeTahun, String periodeLabel, int gajiBersih, bool sudahDitransfer
});
...
/// @nodoc
class __$GetSlipGajiResponseCopyWithImpl<$Res>
    implements _$GetSlipGajiResponseCopyWith<$Res> {
  __$GetSlipGajiResponseCopyWithImpl(this._self, this._then);

  final _GetSlipGajiResponse _self;
  final $Res Function(_GetSlipGajiResponse) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? penggajianId = null,Object? periodeBulan = null,Object? periodeTahun = null,Object? periodeLabel = null,Object? gajiBersih = null,Object? sudahDitransfer = null,}) {
  return _then(_GetSlipGajiResponse(
penggajianId: null == penggajianId ? _self.penggajianId : penggajianId // ignore: cast_nullable_to_non_nullable
as String,periodeBulan: null == periodeBulan ? _self.periodeBulan : periodeBulan // ignore: cast_nullable_to_non_nullable
as int,periodeTahun: null == periodeTahun ? _self.periodeTahun : periodeTahun // ignore: cast_nullable_to_non_nullable
as int,periodeLabel: null == periodeLabel ? _self.periodeLabel : periodeLabel // ignore: cast_nullable_to_non_nullable
